...
// ── Game 1: Electronic Lab (Breadboard Wiring) ─────────────────────────────
type ComponentId =
  | "resistor"
  | "led"
  | "capacitor"
...
interface CircuitSpec {
  ...
  ohmQuestion?: { r: number; v: number; answer: number; unit: string };
}
const COMP_COLORS: Record<ComponentId, string> = {
  resistor: "#f59e0b",
  led: "#00f5ff",
  capacitor: "#7c3aed",
  transistor: "#10b981",
...
const SPECS: Record<1 | 2 | 3, CircuitSpec> = {
  1: {
    title: "LED Circuit",
  ...
  2: {
    ...
    objective:
      "Battery\u2192Collector | Base-Input\u2192Resistor\u2192Base | Emitter\u2192Ground\u2192LED",
    ohmQuestion: { r: 1000, v: 3.3, answer: 3, unit: "mA" },
    components: [
      {
        id: "bat",
        type: "battery",
  ...
  3: {
    ...
    objective:
      "AC Input \u2192 Bridge Rectifier \u2192 Filter Capacitor \u2192 Load Resistor \u2192 LED indicator",
...
// ── Game 2: Series vs Parallel Analysis ──────────────────────────────────────
...
const CIRCUIT_QUESTIONS: CircuitQuestion[] = [
  ...
  },
  {
    ...
    correctIdx: 2,
    explanation:
      "In parallel, each branch has the same voltage. Removing one branch doesn't affect the others.",
    r1: 60,
    r2: 60,
    voltage: 12,
  },
  {
    ...
    correctIdx: 0,
    explanation:
      "Series circuit: removing one component breaks the circuit. All components go out.",
    r1: 60,
    r2: 60,
    voltage: 12,
  },
  {
    ...
    correctIdx: 0,
    explanation:
      "Parallel: same voltage, so I=V/R. Lower resistance draws more current. 40\u03a9: 300mA vs 60\u03a9: 200mA.",
    r1: 40,
    r2: 60,
    voltage: 12,
  },
  ...
  },
  {
    ...
    correctIdx: 0,
    explanation:
      "I_total = V/R1 + V/R2 = 12/120 + 12/40 = 0.1 + 0.3 = 0.4A = 400mA",
    r1: 120,
    r2: 40,
    voltage: 12,
  },
...
function SymbolSVG({ name, color }: { name: string; color: string }) {
  const d = 60;
  switch (name) {
    case "resistor":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          <line x1="0" y1="15" x2="10" y2="15" stroke={color} strokeWidth="2" />
          <polyline
    ...
    case "capacitor":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          ...
          <line x1="35" y1="5" x2="35" y2="25" stroke={color} strokeWidth="3" />
          <line
            x1="35"
            y1="15"
            x2="60"
    ...
    case "diode":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          <line x1="0" y1="15" x2="20" y2="15" stroke={color} strokeWidth="2" />
          <polygon
            ...
            strokeWidth="2"
          />
          <line x1="40" y1="5" x2="40" y2="25" stroke={color} strokeWidth="2" />
          <line
            x1="40"
            y1="15"
            x2="60"
    ...
    case "npn_transistor":
      return (
        <svg width={d} height="50" viewBox="0 0 60 50">
          <circle
            cx="30"
            cy="25"
            r="20"
            ...
            strokeWidth="2"
          />
          <line x1="0" y1="25" x2="18" y2="25" stroke={color} strokeWidth="2" />
          <line
            x1="18"
            y1="10"
            x2="18"
            ...
            strokeWidth="3"
          />
          <line x1="18" y1="18" x2="40" y2="8" stroke={color} strokeWidth="2" />
          <line
            x1="18"
            y1="32"
            x2="40"
    ...
    case "led":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          <line x1="0" y1="15" x2="15" y2="15" stroke={color} strokeWidth="2" />
          <polygon
            ...
            strokeWidth="2"
          />
          <line x1="35" y1="5" x2="35" y2="25" stroke={color} strokeWidth="2" />
          <line
            x1="35"
            y1="15"
            x2="55"
    ...
    case "ground":
      return (
        <svg width="40" height={d} viewBox="0 0 40 60">
          <line x1="20" y1="0" x2="20" y2="25" stroke={color} strokeWidth="2" />
          <line x1="5" y1="25" x2="35" y2="25" stroke={color} strokeWidth="3" />
          <line
            x1="10"
            y1="33"
            x2="30"
    ...
    case "inductor":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          <line x1="0" y1="15" x2="8" y2="15" stroke={color} strokeWidth="2" />
          <path
    ...
    case "battery":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          <line x1="0" y1="15" x2="18" y2="15" stroke={color} strokeWidth="2" />
          <line x1="18" y1="6" x2="18" y2="24" stroke={color} strokeWidth="3" />
          <line
            x1="24"
            y1="10"
            x2="24"
            ...
            strokeWidth="2"
          />
          <line x1="30" y1="6" x2="30" y2="24" stroke={color} strokeWidth="3" />
          <line
            x1="36"
            y1="10"
            x2="36"
    ...
    case "switch":
      return (
        <svg width={d} height="30" viewBox="0 0 60 30">
          ...
          <line x1="15" y1="15" x2="42" y2="5" stroke={color} strokeWidth="2" />
      ...
      return (
        <svg width={d} height="50" viewBox="0 0 60 50">
          <polygon
            ...
            strokeWidth="2"
          />
          <line x1="0" y1="17" x2="10" y2="17" stroke={color} strokeWidth="2" />
          <line x1="0" y1="33" x2="10" y2="33" stroke={color} strokeWidth="2" />
          <line
            x1="50"
            y1="25"
            x2="60"
            ...
            strokeWidth="2"
          />
          <text x="20" y="22" fill={color} fontSize="10" fontWeight="bold">
            +
          </text>
          <text x="20" y="36" fill={color} fontSize="10" fontWeight="bold">
            -
          </text>
        </svg>
      );
      ...
      return (
        <svg width={d} height="50" viewBox="0 0 60 50">
          ...
          <line
            ...
            strokeWidth="3"
          />
          <line x1="22" y1="12" x2="22" y2="38" stroke="none" />
          <line x1="24" y1="15" x2="40" y2="8" stroke={color} strokeWidth="2" />
          <line
            x1="24"
            y1="25"
            x2="40"
...
// ── GAME 1 COMPONENT ──────────────────────────────────────────────────────────
function ElectronicLabGame({ config, onGameEnd }: Props) {
  ...
  const [ohmAnswer, setOhmAnswer] = useState("");
  const [ohmSolved, setOhmSolved] = useState(false);
  const [ohmError, setOhmError] = useState(false);
  ...
  const endGame = useCallback(
    (completed: boolean) => {
      ...
      const acc = completed
        ? 95
        : (connected / spec.requiredConnections.length) * 100;
      onGameEnd(
  ...
  function handleComponentClick(compId: string) {
    ...
    const exists = wires.some(
      (w) =>
        (w.from === connecting && w.to === compId) ||
        (w.from === compId && w.to === connecting),
    );
    if (exists) {
      setConnecting(null);
      return;
    ...
    const isValid = spec.requiredConnections.some(
      ([a, b]) =>
        (a === connecting && b === compId) ||
        (a === compId && b === connecting),
    );
    if (!isValid) {
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground mb-2 text-sm">
            Click two components to connect them with a wire. Build the
            specified circuit to complete the lab.
          </p>
          <p className="text-[#f43f5e] text-xs mb-6">
            Wrong connections cause short circuits and cost lives!
          </p>
          <GlowButton
            variant="primary"
            size="lg"
  ...
  return (
    ...
    >
      ...
      <div className="glass-card rounded-xl p-3 shrink-0">
        ...
        <p className="text-sm font-bold mt-1">{spec.objective}</p>
      </div>
      <div
      ...
      >
        ...
        {components.map((comp) => (
          ...
          >
            ...
            <span style={{ fontSize: "9px" }}>{comp.label}</span>
          </motion.button>
        ))}
        <AnimatePresence>
          {shortCircuit && (
        ...
        <AnimatePresence>
          {circuitComplete && (
            ...
            >
              <div className="glass-card rounded-2xl p-6 text-center max-w-xs w-full border border-[#10b981]">
                <CheckCircle className="h-10 w-10 mx-auto mb-2 text-[#10b981]" />
                <p
                ...
                {spec.ohmQuestion && !ohmSolved && (
                  <>
                    <p className="text-sm text-foreground mb-2">
                      Apply Ohm's Law: V={spec.ohmQuestion.v}V, R=
                      {spec.ohmQuestion.r}\u03a9
                    </p>
                    <p className="text-xs text-muted-foreground mb-3">
                      Current I = V/R = ? ({spec.ohmQuestion.unit})
                    </p>
      ...
      {connecting && (
        <div
          ...
          style={{ fontFamily: "'Orbitron', sans-serif" }}
        >
          Connecting from: {connecting} — click target component
        </div>
      )}
    </div>
  );
...
// ── GAME 2 COMPONENT ──────────────────────────────────────────────────────────
function SeriesParallelGame({ config, onGameEnd }: Props) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <p className="text-muted-foreground mb-2 text-sm">
            Circuit diagrams shown side by side. Answer questions about total
            resistance, current distribution, and component behavior.
          </p>
          <p className="text-muted-foreground text-xs mb-6">
            Master the fundamental difference between series and parallel
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          >
            ...
            >
              {q.circuitType.toUpperCase()} CIRCUIT — {q.description}
            </p>
...
// ── GAME 3 COMPONENT ──────────────────────────────────────────────────────────
function ComponentQuizGame({ config, onGameEnd }: Props) {
  const count = config.difficulty === 1 ? 6 : config.difficulty === 2 ? 13 : 20;
  const questions = SYMBOL_QUESTIONS.slice(0, count);
  const [idx, setIdx] = useState(0);
  const [nameSelected, setNameSelected] = useState<number | null>(null);
  const [funcSelected, setFuncSelected] = useState<number | null>(null);
  const [nameAnswered, setNameAnswered] = useState(false);
  const [funcAnswered, setFuncAnswered] = useState(false);
  const [score, setScore] = useState(0);
  const [lives, setLives] = useState(config.livesCount);
  const [correct, setCorrect] = useState(0);
  const [total, setTotal] = useState(0);
  ...
  function handleNameAnswer(optIdx: number) {
  ...
  function handleFuncAnswer(optIdx: number) {
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            Electronic Symbol Quiz
          </h2>
          <p className="text-muted-foreground mb-2 text-sm">
            Circuit symbols appear one at a time. Identify the component name,
            then classify its function in a schematic.
          </p>
          <p className="text-muted-foreground text-xs mb-6">
            20 standard IEC/ANSI symbols including resistors, transistors, ICs,
            and more.
          </p>
          <GlowButton
            variant="primary"
    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="flex flex-col gap-3 flex-1"
        >
          <div className="glass-card rounded-xl p-4 shrink-0 flex flex-col items-center gap-3 border border-[#e879f9]/30">
            <p
              className="text-xs text-muted-foreground"
              style={{ fontFamily: "'Orbitron', sans-serif" }}
            >
              SYMBOL #{idx + 1} OF {questions.length}
            </p>
            <div className="flex items-center justify-center bg-[#0a0a1a] rounded-xl p-4 w-full min-h-16">
              <SymbolSVG name={q.symbolName} color={q.color} />
            </div>
          ...
          {nameAnswered && (
            <div className="shrink-0">
              ...
              >
                STEP 2: Select its primary function
              </p>
              <div className="grid grid-cols-2 gap-2">
                {q.functionOptions.map((opt, i) => {
                  let bc = "border-border/30 hover:border-[#00f5ff]/40";
                  if (funcAnswered) {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-1">
                        {funcAnswered && i === q.correctFunction && (
                          <CheckCircle className="h-3 w-3 text-[#10b981]" />
                        )}
                        {funcAnswered &&
                          i === funcSelected &&
...
// ── MAIN EXPORT ───────────────────────────────────────────────────────────────
export default function CircuitsHub(props: Props) {
  switch (props.config.gameId) {
    case "series-parallel":
      return <SeriesParallelGame {...props} />;
    case "component-quiz":
      return <ComponentQuizGame {...props} />;
    default:
      return <ElectronicLabGame {...props} />;
  }
}
