// Basic 1–9 progression data for SmartLearn Quest
...
// Helpers to build sub-game slot arrays
...
const ICT_CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    description:
      "Professional email writing, inbox management, and communication",
  ...
  },
  {
    ...
    description:
      "Evolution of computing, pioneers, and technological milestones",
...
// ─── Subject templates per Basic level ───────────────────────────────────────
function makeICTSubject(): SubjectDef {
  return {
    id: "ict",
    name: "ICT",
...
function makeMathSubject(): SubjectDef {
  return {
    id: "mathematics",
    name: "Mathematics",
    color: "oklch(0.78 0.20 60)",
    iconPath:
      "M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 11h.01M12 11h.01M15 11h.01M4 19h16a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2z",
    description:
...
function makeEnglishSubject(): SubjectDef {
  return {
    id: "english",
    name: "English",
...
function makeScienceSubject(): SubjectDef {
  return {
    id: "science",
    name: "Science",
...
function makeRoboticsSubject(): SubjectDef {
  return {
    id: "robotics",
    name: "Robotics",
    color: "oklch(0.72 0.25 15)",
    iconPath:
      "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17H3a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-2",
    description:
...
function makeCriticalThinkingSubject(): SubjectDef {
  return {
    id: "criticalThinking",
...
function makeCodingSubject(): SubjectDef {
  return {
    id: "coding",
    name: "Coding",
...
function makeDigitalSkillsSubject(): SubjectDef {
  return {
    id: "digitalSkills",
    name: "Digital Skills",
    color: "oklch(0.75 0.20 175)",
    iconPath:
      "M21 12a9 9 0 0 1-9 9m9-9a9 9 0 0 0-9-9m9 9H3m9 9a9 9 0 0 1-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9",
    description:
      "Social media literacy, digital citizenship, and online collaboration",
    categories: buildDigitalSkillsCategories(),
  };
}

// Simplified category builders for non-ICT subjects (5 categories × 15 subgames)
function buildMathCategories(): Category[] {
  const names = [
  ...
  return names.map((name, idx) => ({
    ...
    subGames: Array.from({ length: 15 }, (_, i) => ({
      ...
      unlockAtXP: i * 100,
      difficulty: (Math.floor(i / 5) + 1) as 1 | 2 | 3,
    })),
  }));
}

function buildEnglishCategories(): Category[] {
  const names = [
    "Grammar Foundations",
    "Vocabulary Building",
...
function buildScienceCategories(): Category[] {
  const names = [
    "Human Body Systems",
    "Plants and Animals",
    "Space Exploration",
...
function buildRoboticsCategories(): Category[] {
  const names = [
    "Robot Assembly",
    "Sensor Systems",
    "Circuit Building",
...
function buildCriticalThinkingCategories(): Category[] {
  const names = [
    "Logic Puzzles",
    "Memory Training",
    "Strategy Games",
...
function buildCodingCategories(): Category[] {
  const names = [
    "Block Coding Basics",
    "Scratch Projects",
    "Python Introduction",
...
function buildDigitalSkillsCategories(): Category[] {
  const names = [
    "Digital Citizenship",
    "Social Media Safety",
...
export const BASIC_LEVELS: BasicLevel[] = Array.from({ length: 9 }, (_, i) => ({
  id: `basic-${i + 1}`,
  name: `Basic ${i + 1}`,
...
export function getBasicLevel(id: string): BasicLevel | undefined {
  return BASIC_LEVELS.find((l) => l.id === id);
}

export function getSubjectInLevel(
  levelId: string,
  subjectId: string,
): SubjectDef | undefined {
  const level = getBasicLevel(levelId);
  return level?.subjects.find((s) => s.id === subjectId);
}

export function getCategoryInSubject(
  levelId: string,
  subjectId: string,
  categoryId: string,
): Category | undefined {
