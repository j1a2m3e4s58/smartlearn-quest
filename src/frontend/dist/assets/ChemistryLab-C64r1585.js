...
const LAB_SCENARIOS = [
  {
    scenario: "You mix bleach (sodium hypochlorite) with ammonia-based cleaner in a beaker.",
  ...
  {
    scenario: "You are heating a liquid in a test tube without wearing safety goggles.",
  ...
  {
    scenario: "You need to pour concentrated sulfuric acid into water to dilute it.",
  ...
  {
    scenario: "You are working with flammable solvents near a lit Bunsen burner.",
  ...
  {
    scenario: "You finish an experiment using hazardous chemicals and want to dispose of waste.",
    hazard: "Pouring chemicals down the sink may cause reactions or environmental harm.",
    procedures: [
  ...
  {
    scenario: "You are working with a chemical and need to eat lunch right after.",
  ...
  },
  {
    ...
    hazard: "Leaving chemicals unattended can cause fire, spills, or reactions.",
    procedures: [
...
function ChemistryLab({ config, onGameEnd }) {
  const gameId = config.gameId;
  if (gameId === "element-identifier")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ElementIdentifier, { config, onGameEnd });
  if (gameId === "lab-safety")
    return /* @__PURE__ */ jsxRuntimeExports.jsx(LabSafety, { config, onGameEnd });
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ReactionEngine, { config, onGameEnd });
}
function ReactionEngine({ config, onGameEnd }) {
  ...
  const [reaction, setReaction] = reactExports.useState("idle");
  ...
  const flaskColor = reaction === "success" ? "#10b981" : reaction === "explosion" ? "#f43f5e" : "#00f5ff";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-10 text-center max-w-md w-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  ...
                  children: "Lab Reaction Engine"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-2 text-sm", children: "Select 2 reactants to synthesize the target compound. Wrong pair causes an explosion!" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlowButton,
                {
                  variant: "primary",
        ...
        (phase === "playing" || phase === "feedback") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex gap-3 min-h-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-56 flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
            ...
            currentC.reactants.map((r, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.button,
                {
                  ...
                  children: [
                    isSel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-[#00f5ff] inline-block mr-2" }),
                    r
                  ]
                },
                `r-${i}`
...
function ElementIdentifier({ config, onGameEnd }) {
  const totalQ = config.difficulty === 1 ? 8 : config.difficulty === 2 ? 12 : 20;
          ...
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-10 text-center max-w-md w-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground mb-2 text-sm", children: [
                "An element symbol is shown. Identify its name, atomic number, and group. ",
                totalQ,
                " elements total."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlowButton,
                {
                  ...
                  children: "Enter Periodic Table"
                }
              )
            ] })
          }
        ),
        (phase === "name" || phase === "group" || phase === "feedback") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3", children: [
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: phase === "name" ? "Name?" : current.name })
                  ]
                }
              )
            },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    style: { fontFamily: "'Orbitron',sans-serif" },
                    children: phase === "name" ? "Step 1 — Identify the element name" : "Step 2 — Identify the group"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: (phase === "name" ? current.nameOptions : current.groupOptions).map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    onClick: () => phase === "name" ? handleName(opt) : handleGroup(opt),
...
function LabSafety({ config, onGameEnd }) {
  const [phase, setPhase] = reactExports.useState("start");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        phase === "start" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-10 text-center max-w-md w-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-2 text-sm", children: "12 dangerous lab scenarios. Identify the hazard and select the correct safety procedure." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlowButton,
                {
                  variant: "primary",
        ...
        (phase === "hazard" || phase === "procedure" || phase === "feedback") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground mb-3", children: current.scenario }),
                (phase === "procedure" || phase === "feedback") && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          ...
                          children: "Hazard Identified:"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: current.hazard })
                    ]
                  }
                )
              ]
          ...
          phase === "hazard" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            GlowButton,
            {
              variant: "primary",
              size: "md",
              ...
              children: "Identify Hazard — Select Procedure"
            }
          ),
          (phase === "procedure" || phase === "feedback") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground px-1", children: "Select the correct safety procedure:" }),
            current.procedures.map((proc, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
