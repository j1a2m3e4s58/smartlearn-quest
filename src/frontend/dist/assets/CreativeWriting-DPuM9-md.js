import { r as reactExports, j as jsxRuntimeExports, m as motion, G as GlowButton, l as Star, n as AnimatePresence } from "./index-bdQaMNSA.js";
...
const DESCRIPTIVE_SENTENCES = [
  ...
  },
  {
    ...
    bestSensory: "horns, voices, and machinery layering into a single deafening presence",
...
const DIALOGUE_SCENES = [
  {
    scene: "Two students discover a locked room in their school that has been sealed for 30 years.",
    ...
    dialogueOptions: [
      {
        ...
        speaker: "A",
        correct: true,
        reason: "Fits Kofi's impulsive bravery and advances the scene with energy."
      },
      {
        text: "Kofi: 'I think we should report this to the headmaster and wait for guidance.'",
        speaker: "A",
        correct: false,
        reason: "Too cautious for an impulsive character — sounds like Ama's voice."
      },
      {
        text: "Ama: 'Before we do anything, we need to find out who sealed this room and why. There could be a reason it was locked.'",
        speaker: "B",
        correct: true,
        reason: "Perfectly fits Ama's analytical caution and creates tension with Kofi's urgency."
      },
      {
        text: "Ama: 'Yes! Let's go in right now before anyone sees us!'",
        speaker: "B",
        correct: false,
        reason: "Too reckless for a cautious character — this is Kofi's voice, not Ama's."
      }
    ],
    punctQuestions: [
      {
        ...
        correctIdx: 0,
        explanation: "A comma follows the speech tag before the direct speech begins."
      },
      {
        ...
        correctIdx: 0,
        explanation: "Speech marks enclose only the spoken words, after the speech tag and comma."
      },
      {
        ...
        correctIdx: 0,
        explanation: "Every change of speaker starts a new paragraph in correctly formatted dialogue."
      }
    ]
  },
  {
    scene: "A student has missed a group deadline and must explain themselves to the group leader.",
    ...
    dialogueOptions: [
      {
        ...
        speaker: "A",
        correct: true,
        reason: "Direct, factual, holds accountability without aggression. True to Yaw's principled voice."
      },
      {
        text: "Yaw: 'It is okay, these things happen. We will fix it together.'",
        speaker: "A",
        correct: false,
        reason: "Too forgiving for a direct, principled character who has been let down."
      },
      {
        text: "Efua: 'I know, I know! You don't have to keep going on about it. I had problems this week, okay?'",
        speaker: "B",
        correct: true,
        reason: "Defensive and emotionally reactive — authentic to Efua's established voice."
      },
      {
        text: "Efua: 'You are completely right. I take full responsibility and I am deeply sorry.'",
        speaker: "B",
        correct: false,
        reason: "Too composed and accountable for a defensive, emotional character."
      }
    ],
    punctQuestions: [
      {
        ...
        correctIdx: 0,
        explanation: "The question mark or exclamation mark replaces the usual full stop inside the closing speech mark."
      },
      {
        ...
        correctIdx: 0,
        explanation: "The question mark inside the speech marks, lowercase continuation for the attribution."
      },
      {
        ...
        correctIdx: 0,
        explanation: "The new paragraph rule exists specifically to help readers track changes of speaker without confusion."
      }
    ]
  },
  {
    scene: "Two scientists disagree about which experiment to run next with limited resources.",
    ...
    dialogueOptions: [
      {
        ...
        speaker: "A",
        correct: true,
        reason: "Methodical, cites evidence and process risk. Fully fits Dr Nyarko's character."
      },
      {
        text: "Dr Nyarko: 'Your instinct might be right. Let us take the chance.'s worth trying.'",
        speaker: "A",
        correct: false,
        reason: "Abandons evidence-driven character to validate an intuitive decision — wrong voice."
      },
      {
        text: "Dr Ampah: 'Sometimes science needs a leap. If we wait for perfect conditions, we will never make the discovery.'",
        speaker: "B",
        correct: true,
        reason: "Risk-taking, passionate, challenges the methodical approach. Authentic to Dr Ampah."
      },
      {
        text: "Dr Ampah: 'I agree with you. The data clearly supports the baseline approach.'",
        speaker: "B",
        correct: false,
        reason: "Entirely contradicts the intuitive, risk-taking character trait established."
      }
    ],
    punctQuestions: [
      {
        ...
        correctIdx: 0,
        explanation: "Comma after speech tag, capital letter to open speech, closing punctuation inside speech marks."
      },
      {
        ...
        correctIdx: 0,
        explanation: "Interruptions use an em dash (—) or ellipsis (...) to show the speech was cut off."
      },
      {
        question: "When the attribution follows the speech, the speech ends with:",
        options: [
        ...
        correctIdx: 0,
        explanation: "When dialogue is followed by an attribution, a comma (not full stop) closes the speech."
      }
    ]
  },
  {
    scene: "Two students are deciding whether to tell the truth about a broken school trophy.",
    ...
    dialogueOptions: [
      {
        ...
        speaker: "A",
        correct: true,
        reason: "Honest, morally clear, faces consequences. True to Adjoa's established character."
      },
      {
        text: "Adjoa: 'No one saw us. We can just say it was already broken when we arrived.'",
        speaker: "A",
        correct: false,
        reason: "Completely contradicts the honest, morally courageous character."
      },
      {
        ...
        speaker: "B",
        correct: true,
        reason: "Calculative, weighs personal cost, typical of a pragmatic self-preserving character."
      },
      {
    ...
    punctQuestions: [
      {
        ...
        correctIdx: 0,
        explanation: "Comma inside speech before interrupting tag, lowercase tag, comma after tag, lowercase continuation."
      },
      {
        ...
        correctIdx: 0,
        explanation: "In dialogue, speech marks enclose exact spoken words. Thoughts use italics or free indirect style."
      },
      {
        ...
        correctIdx: 0,
        explanation: "The attribution after speech marks continues with lowercase unless a proper name follows."
      }
    ]
  },
  {
    ...
    dialogueOptions: [
      {
        ...
        speaker: "A",
        correct: true,
        reason: "Firm, sets a clear boundary, acknowledges the teen's position, offers a negotiation space. Fits the character."
      },
      {
        text: "Parent: 'Fine, three hours then. Whatever makes you happy.'",
        speaker: "A",
        correct: false,
        reason: "Too permissive and emotionally driven for a firm but fair character."
      },
      {
        ...
        speaker: "B",
        correct: true,
        reason: "Passionate, uses peer comparison as argument, feels unjustly treated. Authentic to the character."
      },
      {
        text: "Teen: 'I understand. Two hours is probably sensible given the research on sleep.'",
        speaker: "B",
        correct: false,
        reason: "Completely out of character for a passionate, argumentative teen in a heated negotiation."
      }
    ],
    punctQuestions: [
      {
        ...
        correctIdx: 0,
        explanation: "Overuse of exclamation marks weakens their effect. Reserve them for genuine emotional peaks."
      },
      {
        question: "Which correctly shows a character talking about someone else's speech?",
        options: [
        ...
        correctIdx: 1,
        explanation: "Reported speech does not use speech marks. Only direct quotation within dialogue uses nested marks."
      },
      {
        ...
        correctIdx: 0,
        explanation: "A firm but fair character states positions clearly, acknowledges the other party, and maintains boundaries — this is what the dialogue structure should reflect."
      }
    ]
  }
];
function CreativeWriting({ config, onGameEnd }) {
  ...
  const [totalWords, setTotalWords] = reactExports.useState(0);
  const [lastInserted, setLastInserted] = reactExports.useState(null);
  function startG1() {
  ...
  function submitStory() {
    ...
    const preciseCount = selections.filter(
      (s) => (s == null ? void 0 : s.quality) === "precise"
    ).length;
  ...
  function buildStoryPreview() {
    ...
    template.parts.forEach((part, i) => {
      out.push(/* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: part }, `p-${i}`));
        ...
        out.push(
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: sel ? sel.word : `[${slot.label}]`
            },
            `slot-${slotIdx}`
          )
        );
  ...
  const sentenceCount = config.difficulty === 1 ? 4 : config.difficulty === 2 ? 7 : 10;
  const [g2Sentences] = reactExports.useState(
    () => [...DESCRIPTIVE_SENTENCES].sort(() => Math.random() - 0.5).slice(0, sentenceCount)
  );
  const [g2Phase, setG2Phase] = reactExports.useState("idle");
  const [g2Idx, setG2Idx] = reactExports.useState(0);
  const [g2Verb, setG2Verb] = reactExports.useState(null);
  const [g2Adjs, setG2Adjs] = reactExports.useState([]);
  const [g2Sensory, setG2Sensory] = reactExports.useState(null);
  const [g2Submitted, setG2Submitted] = reactExports.useState(false);
  const usedWords = reactExports.useRef(/* @__PURE__ */ new Set());
  ...
  function submitG2() {
    ...
    const adjCorrect = g2Adjs.filter(
      (a) => g2Sentence.bestAdjs.includes(a)
    ).length;
    const sensoryCorrect = g2Sensory === g2Sentence.bestSensory;
    const pts = (verbCorrect ? 150 : 30) + adjCorrect * 80 + (sensoryCorrect ? 120 : 30);
  ...
  function buildG2Enhanced() {
    ...
    return g2Sentence.enhancedTemplate.replace("{verb}", g2Verb).replace("{adj1}", g2Adjs[0]).replace("{adj2}", g2Adjs[1] || "").replace("{sensory}", g2Sensory);
  }
  const sceneCount = config.difficulty === 1 ? 3 : config.difficulty === 2 ? 5 : 8;
  const [g3Scenes] = reactExports.useState(
  ...
  const [g3SelectedLines, setG3SelectedLines] = reactExports.useState([]);
  const [g3PunctAnswers, setG3PunctAnswers] = reactExports.useState([]);
  const [g3Submitted, setG3Submitted] = reactExports.useState(false);
  const [g3PunctSubmitted, setG3PunctSubmitted] = reactExports.useState(false);
  const g3Scene = g3Scenes[g3Idx];
  function toggleG3Line(i) {
    setG3SelectedLines(
      (prev) => prev.includes(i) ? prev.filter((x) => x !== i) : prev.length < 4 ? [...prev, i] : prev
    );
  }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-hud flex items-center justify-between shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-4 w-4 text-[#f59e0b]" }),
        ...
        gameId === "story-forge" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          g1Phase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-14 w-14 mx-auto mb-4 text-[#f59e0b]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    className: "text-3xl font-black glow-cyan-text mb-2",
                    style: { fontFamily: "'Orbitron', sans-serif" },
                    children: "Story Forge"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6", children: "Fill story template slots with words from the word bank. Rarer, more precise words score higher. Use 2+ precise words for a coherence bonus." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  GlowButton,
                  {
                    variant: "primary",
                    ...
                    children: "Begin Forging"
                  }
                )
              ]
            }
          ) }),
          g1Phase === "play" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-1", children: [
                "Story Template — ",
                template.title
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-loose text-foreground", children: buildStoryPreview() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: activeSlot !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground uppercase tracking-widest", children: [
                ...
                template.slots[activeSlot].label,
                "]"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: template.wordBanks[template.slots[activeSlot].type].map(
                (w, i) => {
                  var _a;
                  const isSelected = ((_a = selections[activeSlot]) == null ? void 0 : _a.word) === w.word;
                    ...
                    motion.button,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-foreground text-sm", children: w.word }),
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            style: { color: QUALITY_COLORS[w.quality] },
                            children: QUALITY_LABELS[w.quality]
                          }
                        )
                      ]
                    },
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Click a [SLOT] in the story to select words" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: lastInserted !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
          ...
          g1Phase === "result" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-2xl p-5 neon-top-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground uppercase tracking-widest mb-2", children: [
                "Completed Story — ",
                template.title
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm leading-loose text-foreground", children: buildStoryPreview() })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-4 flex flex-col gap-2", children: [
              selections.map(
                (sel, i) => sel && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "flex items-center justify-between",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground font-semibold", children: sel.word }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            ...
                            children: QUALITY_LABELS[sel.quality]
                          }
                        ),
              ...
              selections.filter((s) => (s == null ? void 0 : s.quality) === "precise").length >= 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-t border-border/30 pt-2 mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-[#10b981] font-bold", children: "Coherence Bonus" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-mono text-[#10b981]", children: [
                  "+",
                  100 * config.difficulty
                ] })
              ] })
            ] }),
            templateIdx + 1 < templates.length ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              GlowButton,
              {
                variant: "primary",
                className: "flex-1",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-[#00f5ff] font-bold", children: [
                "Score this round: ",
                g1Score.toLocaleString()
              ] })
            ] })
          ] })
        ] }),
        gameId === "descriptive-painter" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          g2Phase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "glass-card rounded-2xl p-10 text-center max-w-lg w-full",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-14 w-14 mx-auto mb-4 text-[#a855f7]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "Descriptive Painter"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mb-2", children: [
                  sentenceCount,
                  " plain sentences. For each: pick 1 strong verb, 2 adjectives, and 1 sensory detail to transform it into vivid writing."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-6", children: "Best verb: +150 pts. Each correct adjective: +80 pts. Best sensory: +120 pts." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  GlowButton,
                  {
                    variant: "primary",
                    ...
                    children: "Begin Painting"
                  }
                )
              ]
            }
          ) }),
          (g2Phase === "playing" || g2Phase === "result") && g2Sentence && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-4 border border-[#a855f7]/30 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-foreground mb-2", children: [
                "PLAIN:",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: g2Sentence.plain })
              ] }),
              g2Verb && g2Adjs.length >= 2 && g2Sensory && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-[#a855f7]", children: [
                "ENHANCED: ",
                buildG2Enhanced()
              ] })
            ] }),
            !g2Submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground mb-2", children: "Pick 1 strong verb:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: g2Sentence.verbOptions.map((v, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setG2Verb(v),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground mb-2", children: "Pick 2 adjectives:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: g2Sentence.adjOptions.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => setG2Adjs(
                      (prev) => prev.includes(a) ? prev.filter((x) => x !== a) : prev.length < 2 ? [...prev, a] : prev
                    ),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground mb-2", children: "Pick 1 sensory detail:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: g2Sentence.sensoryOptions.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlowButton,
                {
                  ...
                  children: "Submit Enhancement"
                }
              )
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-4 border border-[#10b981]/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-[#10b981] mb-2", children: "Results:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                  g2Verb === g2Sentence.bestVerb ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-3 w-3 text-[#10b981]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-3 w-3 text-[#f43f5e]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", children: [
                    'Verb "',
                    g2Verb,
                    '" —',
                    " ",
                    g2Verb === g2Sentence.bestVerb ? "strongest choice" : `best was "${g2Sentence.bestVerb}"`
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", children: [
                  "Adjectives:",
                  " ",
                  g2Adjs.filter((a) => g2Sentence.bestAdjs.includes(a)).length,
                  "/2 correct (best: ",
                  g2Sentence.bestAdjs.join(", "),
                  ")"
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  g2Sensory === g2Sentence.bestSensory ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-3 w-3 text-[#10b981]" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-3 w-3 text-[#f43f5e]" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs", children: [
                    "Sensory —",
                    " ",
                    g2Sensory === g2Sentence.bestSensory ? "most vivid choice" : `best was "${g2Sentence.bestSensory}"`
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                GlowButton,
                {
                  ...
                  children: g2Idx + 1 < g2Sentences.length ? "Next Sentence" : "Finish"
                }
              )
            ] })
          ] })
        ] }),
        gameId === "dialogue-writer" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          g3Phase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "glass-card rounded-2xl p-10 text-center max-w-lg w-full",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-14 w-14 mx-auto mb-4 text-[#10b981]" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    className: "text-3xl font-black mb-2",
                    ...
                    children: "Dialogue Writer"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm mb-2", children: [
                  sceneCount,
                  " scenes. For each: select 4 dialogue lines matching character voices, then answer punctuation questions."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mb-6", children: "Each correct line: +100 pts. Each correct punctuation: +80 pts." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  GlowButton,
                  {
                    variant: "primary",
          ...
          g3Phase === "dialogue" && g3Scene && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card rounded-xl p-4 border border-[#10b981]/30 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "p",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-2", children: g3Scene.scene }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#7c3aed] font-bold", children: [
                    g3Scene.charA.name,
                    ":"
                  ] }),
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: g3Scene.charA.trait })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs", children: [
                  ...
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: g3Scene.charB.trait })
                ] })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground", children: "Select 4 dialogue lines that best match each character's voice and advance the scene:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: g3Scene.dialogueOptions.map((opt, i) => {
              const sel = g3SelectedLines.includes(i);
              const isA = opt.speaker === "A";
              const showResult = g3Submitted;
              let cls = "border-border/40 text-foreground hover:border-[#10b981]/40";
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.button,
                {
                  ...
                  children: [
                    ...
                    g3Submitted && sel && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 text-xs opacity-70", children: opt.reason })
                  ]
                },
                i
              );
            }) }),
            !g3Submitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
              GlowButton,
              {
                variant: "primary",
                size: "md",
              ...
              GlowButton,
              {
                ...
                children: "Continue to Punctuation"
              }
            )
          ] }),
          g3Phase === "punctuation" && g3Scene && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass-card rounded-xl p-3 border border-[#f59e0b]/30 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "p",
              {
            ...
            g3Scene.punctQuestions.map((q, qi) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "glass-card rounded-xl p-4 border border-border/30",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground mb-2", children: q.question }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1", children: q.options.map((opt, oi) => {
                    const sel = g3PunctAnswers[qi] === oi;
                    const showResult = g3PunctSubmitted;
                    const correct_opt = oi === q.correctIdx;
                    let cls = "border-border/40 hover:border-[#f59e0b]/40 text-foreground";
                    ...
                    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "button",
                      {
                        ...
                        children: [
                          opt,
                          showResult && correct_opt && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 opacity-70", children: [
                            "— ",
                            q.explanation
                          ] })
                        ]
            ...
            !g3PunctSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              GlowButton,
              {
                variant: "primary",
                size: "md",
                disabled: g3PunctAnswers.length !== g3Scene.punctQuestions.length || g3PunctAnswers.some((a) => a === void 0),
                onClick: submitG3Punctuation,
                "data-ocid": "creative_writing.g3_submit_punct",
                children: "Submit Punctuation"
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              GlowButton,
              {
                ...
                children: g3Idx + 1 < g3Scenes.length ? "Next Scene" : "Finish"
              }
            )
          ] })
        ] })
