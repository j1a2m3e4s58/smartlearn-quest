import { c as createLucideIcon, R as React, r as reactExports, v as vt, u as useNavigate, a as useAllHubProgress, b as useAudioContext, j as jsxRuntimeExports, P as ParticleBackground, m as motion, L as Link, S as SUBJECTS, d as Lock, e as ProgressRing, C as ChevronRight } from "./index-bdQaMNSA.js";
...
function SubjectNode({
  ...
  const progressPercent = subject.hubCount > 0 ? Math.round(completedHubs / subject.hubCount * 100) : 0;
  const isLocked = !subject.unlocked;
  const handleClick = () => {
    if (isLocked) {
      ue.error("World Locked", {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      className: [
        ...
        "glass-card border",
        isLocked ? "cursor-not-allowed opacity-50 border-border/20" : "cursor-pointer border-border/30 hover:border-opacity-60"
      ].join(" "),
      style: {
        borderColor: !isLocked ? `${subject.color}40` : void 0,
        boxShadow: !isLocked ? `0 0 0 0 ${subject.color}00, inset 0 1px 0 rgba(255,255,255,0.06)` : "inset 0 1px 0 rgba(255,255,255,0.03)"
      },
      children: [
        ...
        isLocked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center gap-2 bg-background/60 backdrop-blur-sm z-10 rounded-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "h-8 w-8 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold tracking-widest uppercase text-muted-foreground text-center px-4", children: "Complete previous world to unlock" })
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-6 w-6", style: { color: subject.color } })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ProgressRing,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "h2",
              {
                ...
                style: {
                  ...
                  color: !isLocked ? subject.color : void 0
                },
                children: subject.name
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-clamp-2 leading-relaxed", children: SUBJECT_DESCRIPTIONS[subject.id] })
          ] }),
...
function WorldMapPage() {
  ...
  const getCompletedHubs = (subjectId) => {
    return hubProgress.filter((hp) => {
      var _a;
      return (_a = hp.hubId) == null ? void 0 : _a.startsWith(subjectId);
    }).length;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleBackground, { count: 80 }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(ellipse at bottom right, rgba(124,58,237,0.2) 0%, transparent 70%)"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-20", children: [
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  style: {
                    ...
                    boxShadow: "0 0 60px oklch(0.55 0.22 200 / 0.08), inset 0 1px 0 rgba(255,255,255,0.06)"
                  },
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: "linear-gradient(90deg, transparent, oklch(0.75 0.18 200), transparent)"
                        }
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        style: {
                          background: "radial-gradient(ellipse at 50% 0%, oklch(0.55 0.22 200 / 0.06) 0%, transparent 60%)"
                        }
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative px-6 py-8 sm:px-10 sm:py-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-3 py-1 rounded-full border border-primary/30 bg-primary/10 mb-4", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Map, { className: "h-3 w-3 text-primary" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold tracking-widest uppercase text-primary", children: "Structured Curriculum Path" })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "h2",
                          {
                            ...
                            style: {
                              fontFamily: "'Orbitron', sans-serif",
                              background: "linear-gradient(135deg, oklch(0.85 0.18 200), oklch(0.75 0.22 260))",
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-md leading-relaxed", children: "Explore structured learning paths from Basic 1 to Basic 9. Each world contains hundreds of missions, games, and discoveries across all subjects." })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        Link,
                        {
                          ...
                          style: {
                            background: "linear-gradient(135deg, oklch(0.55 0.22 200), oklch(0.50 0.25 260))",
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 mb-5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-bold tracking-widest uppercase text-primary", children: "Knowledge Dimensions" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h1",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto glass rounded-xl p-5 border border-border/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm sm:text-base text-muted-foreground leading-relaxed", children: [
                  "The Knowledge Dimensions have been shattered. Restore intelligence to civilization by mastering the ancient arts of",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: " computing" }),
                  ",",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-medium", children: " mathematics" }),
                  ",",
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#10b981" }, className: "font-medium", children: [
                    " ",
                    "science"
                  ] }),
                  ", and more. Each world you conquer unlocks the next dimension. The fate of civilization rests on your mastery."
                ] }) })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold tracking-widest uppercase text-muted-foreground", children: "Quick Access" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-border/30" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: SUBJECTS.map((subject, i) => {
                var _a;
                return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${((_a = CARD_POSITIONS[i]) == null ? void 0 : _a.col) ?? ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SubjectNode,
                  {
                    subject,
                    index: i,
                    completedHubs: subject.completedHubs + getCompletedHubs(subject.id),
                    onClick: () => navigate({
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-lg px-3 py-2 border border-border/30 flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2 h-2 rounded-full bg-primary animate-glow-pulse" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold tracking-wider uppercase text-muted-foreground max-w-[160px] leading-tight", children: "Aligned with Ghana Education Service Basic 1–9 Curriculum" })
              ] })
            }
          )
        ] })
