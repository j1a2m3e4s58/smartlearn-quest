import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, a3 as React, a4 as useAuth, a1 as useMyProgression, q as useRouterState, L as Link, m as motion, n as AnimatePresence, Z as Zap } from "./index-bdQaMNSA.js";
import { M as Map$1 } from "./map-CgAdZPgE.js";
import { C as Coins } from "./coins-B9mN5ZCZ.js";
import { X } from "./x-BFFiCf8T.js";
/**
...
const NAV_LINKS = [
  { label: "World Map", path: "/world-map", icon: Map$1 },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex items-center justify-between h-16 px-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: "/world-map",
              ...
              "nav",
              {
                ...
                children: NAV_LINKS.map((link) => {
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    ...
                    {
                      to: link.path,
                      className: `flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium transition-smooth ${isActive ? "bg-primary/10 text-primary border border-primary/30" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              isAuthenticated && progression && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5 min-w-[72px]", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(Coins, { className: "h-4 w-4 text-accent" }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold text-accent", children: coins.toLocaleString() })
                        ]
                      }
                    )
                  ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-3 flex flex-col gap-1", children: [
                NAV_LINKS.map((link) => {
                  const Icon = link.icon;
                  const isActive = currentPath.startsWith(link.path);
                  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Link,
                    {
                      ...
                      className: `flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium transition-smooth ${isActive ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4 w-4" }),
                        link.label
                      ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 bg-background", "data-ocid": "layout.main", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "footer",
      {
        className: "bg-card border-t border-border/40 py-4",
        "data-ocid": "layout.footer",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
          "© ",
