    ...
    stages: {
      ...
      ideate: {
        ...
        options: [
          {
            id: "a",
            label: "Introduce robotic arms for repetitive tasks + worker retraining",
            score: 95
          },
    ...
    stages: {
      ...
      define: {
        ...
        options: [
          {
            id: "a",
            label: "Inadequate drainage infrastructure combined with climate-driven rainfall increases",
            correct: true
          },
          {
            id: "b",
      ...
      ideate: {
        ...
        options: [
          {
            id: "a",
            label: "Smart drainage network + green permeable infrastructure + early warning system",
            score: 95
          },
      ...
      test: {
        ...
        outcomes: [
          {
            id: "a",
            label: "Flood levels reduced 70%, early warnings evacuate 95% of residents",
            good: true
          },
          {
            id: "b",
...
const DESIGN_PROBLEMS = [
  {
    ...
    context: "Secondary school, mixed smartphone ownership, teachers assign work verbally or via whiteboard.",
    empathize: {
      prompt: "What is the best way to understand this problem deeply?",
      options: [
        {
          id: "a",
          label: "Survey 50 students about their homework tracking methods and failure points",
          correct: true,
          explanation: "Primary user research with a representative sample is the gold standard for Empathize phase."
        },
        {
          id: "b",
          label: "Read academic papers about memory and forgetting",
          correct: false,
          explanation: "Academic research is useful background but does not capture this specific user's experience."
        },
        {
          id: "c",
          label: "Ask the headmaster what they think the problem is",
          correct: false,
          explanation: "Administrator perspective misses the student's direct experience of the problem."
        }
      ]
    },
    define: {
      ...
      options: [
        {
          id: "a",
          label: "Students need a reliable, low-effort way to capture and review assignments because current methods depend on memory and inconsistent communication.",
          correct: true,
          explanation: "User-centred, specific, actionable, and points toward solutions without prescribing them."
        },
        {
          id: "b",
          label: "The school needs a homework policy.",
          correct: false,
          explanation: "Too vague, system-focused, not user-centred, and does not capture the root cause."
        },
        {
          id: "c",
          label: "Students should be more responsible.",
          correct: false,
          explanation: "Blames the user rather than framing a design opportunity. Not actionable for a designer."
        }
      ]
    },
    ideate: {
      prompt: "Rank these 6 ideas from most creative/practical (1) to least (6):",
      ideas: [
        { id: "a", label: "Class WhatsApp group where assignments are posted" },
        {
          id: "b",
          label: "School-provided digital assignment tracker app with teacher input"
        },
    ...
    prototype: {
      prompt: "Build the Minimum Viable Product. Select 3 essential features from 8:",
      features: [
        {
          id: "assignment_list",
    ...
    test: {
      prompt: "After 2 weeks of testing, 70% of students completed homework on time but teachers found posting assignments took 5 extra minutes per class. What do you decide?",
      feedback: "Pilot users: strong adoption from students, but teacher time cost is creating resistance.",
      options: [
        {
          id: "a",
          label: "Iterate: streamline the teacher posting flow to under 60 seconds before wider rollout",
          correct: true,
          explanation: "Identifies the specific friction point and plans a targeted iteration. Sound design thinking."
        },
        {
          id: "b",
          label: "Launch immediately — student adoption numbers are strong enough",
          correct: false,
          explanation: "Ignores a critical stakeholder's pain point that will undermine adoption over time."
        },
        {
          id: "c",
          label: "Abandon the project — if teachers won't use it, it will fail",
          correct: false,
          explanation: "Premature abandonment based on solvable friction. The student data is encouraging."
        }
      ]
    }
  },
  {
    ...
    context: "A tech company wants to build an accessible input device. Budget: moderate. Users: physical and motor disabilities.",
    empathize: {
      prompt: "Best user research method for this problem:",
      options: [
        {
          id: "a",
          label: "Conduct contextual observation sessions with 10 users with different disabilities, observing how they currently interact with keyboards",
          correct: true,
          explanation: "Contextual observation captures real barriers that surveys or interviews alone might miss."
        },
        {
          id: "b",
          label: "Review existing accessibility guidelines and standards",
          correct: false,
          explanation: "Guidelines are valuable but secondary research — they cannot replace observing actual user struggles."
        },
        {
          id: "c",
          label: "Prototype a solution based on the design team's assumptions",
          correct: false,
          explanation: "Jumping to prototyping without research produces solutions designed for the team, not the user."
        }
      ]
    },
    define: {
      ...
      options: [
        {
          id: "a",
          label: "People with limited motor control need an input method that adapts to their range of motion because standard keyboards require fine motor skills that many cannot reliably perform.",
          correct: true,
          explanation: "Specific, user-centred, identifies the functional gap, points to an opportunity space."
        },
        {
          id: "b",
          label: "Keyboards are too difficult.",
          correct: false,
          explanation: "Too vague, not user-centred, provides no direction for design."
        },
        {
          id: "c",
          label: "We should build a better keyboard.",
          correct: false,
          explanation: "Jumps to a solution before defining the problem. Not a valid problem statement."
        }
      ]
    },
    ideate: {
      prompt: "Rank these 6 solution ideas from most feasible/impactful (1) to least (6):",
      ideas: [
    ...
    prototype: {
      prompt: "Select 3 MVP features from 8 for an adaptive keyboard prototype:",
      features: [
    ...
    test: {
      prompt: "Testing with 8 users: voice input works well for 6 users, but 2 users with speech impairments cannot use it at all. What do you decide?",
      feedback: "Core voice mode works for most. Speech-impaired users are completely excluded by the primary input method.",
      options: [
        {
          id: "a",
          label: "Iterate: ensure alternative input modes (switch/eye) are equally supported before launch, not as afterthoughts",
          correct: true,
          explanation: "Inclusive design requires all identified user groups to have a viable primary pathway, not just a majority."
        },
        {
          id: "b",
          label: "Launch for the 75% it works for and address the remaining users in version 2",
          correct: false,
          explanation: "Deliberately shipping a product that excludes a known vulnerable group violates accessibility design principles."
        },
        {
          id: "c",
          label: "Remove voice input and focus only on physical alternatives",
          correct: false,
          explanation: "Abandons a proven feature for the majority. The goal is to expand, not contract, the accessible pathway."
        }
      ]
    }
  },
  {
    ...
    context: "Urban market, West Africa, vendors lack weather alerts and protective infrastructure.",
    empathize: {
      prompt: "Best research method to understand the vendors' experience:",
      options: [
        {
          id: "a",
          label: "Spend 3 days at the market, talking to vendors and observing what happens when it rains",
          correct: true,
          explanation: "Ethnographic research at the point of experience generates deep, contextual insights."
        },
        {
          id: "b",
          label: "Check weather bureau statistics for annual rainfall",
          correct: false,
          explanation: "Data on rain frequency does not capture the vendor's experience, coping strategies, or losses."
        },
        {
          id: "c",
          label: "Create a survey and post it in local Facebook groups",
          correct: false,
          explanation: "Many street vendors may not use social media; the sample would be unrepresentative."
        }
      ]
    },
    define: {
      ...
      options: [
        {
          id: "a",
          label: "Street vendors need advance warning of rain and rapid access to protective cover because unexpected rainfall destroys unprotected stock and eliminates daily income.",
          correct: true,
          explanation: "Specific, user-centred, identifies twin needs (warning + protection), quantifies the impact."
        },
        {
          id: "b",
          label: "The market needs better infrastructure.",
          correct: false,
          explanation: "Too broad and system-level. Does not specify the user need or the root cause."
        },
        {
          id: "c",
          label: "Rain is unpredictable and damages goods.",
          correct: false,
          explanation: "Describes the condition, not the user need. Not actionable as a design brief."
        }
      ]
    },
    ideate: {
    ...
    test: {
      prompt: "After 2 weeks: alerts were accurate 8/10 times and 85% of vendors deployed cover in time. However, 30% of vendors missed alerts because they did not check WhatsApp regularly. What do you decide?",
      feedback: "Strong results overall, but a gap in alert reach for low-engagement users.",
      options: [
        {
          id: "a",
          label: "Iterate: add a loud audio alarm or market PA system for vendors who miss digital alerts",
          correct: true,
          explanation: "Addresses the specific gap with a complementary low-tech solution that reaches all users."
        },
        {
          id: "b",
          label: "Require all vendors to check WhatsApp as a condition of using the system",
          correct: false,
          explanation: "Puts burden on users rather than designing around their existing behaviour patterns."
        },
        {
          id: "c",
          label: "Launch as-is — 85% success rate is commercially acceptable",
          correct: false,
          explanation: "The 15% who remain unprotected still lose stock. In human-centred design, acceptable performance means reaching all users."
        }
      ]
    }
  },
  {
    ...
    context: "Large urban hospital, newly digitised. Elderly patients must book online, check in via kiosk, and navigate app.",
    empathize: {
      prompt: "Best method to understand the elderly patients' experience:",
      options: [
        {
          id: "a",
          label: "Accompany 8 elderly patients through the full hospital visit process, noting every friction point",
          correct: true,
          explanation: "Accompanied journey mapping reveals real pain points that patients themselves might not articulate."
        },
        {
          id: "b",
          label: "Read hospital complaint emails from the last year",
          correct: false,
          explanation: "Complaint data reveals only problems patients chose to report — many give up silently."
        },
        {
          id: "c",
          label: "Interview hospital IT staff about system features",
          correct: false,
          explanation: "Designers, not IT staff, experience usability barriers. The user is the source of truth."
        }
      ]
    },
    define: {
      ...
      options: [
        {
          id: "a",
          label: "Elderly patients need a way to complete hospital processes independently because the current digital system assumes literacy, smartphone ownership, and internet access that many elderly people do not have.",
          correct: true,
          explanation: "Names the capability gap, identifies the assumption the system makes, and points toward inclusive design solutions."
        },
        {
          id: "b",
          label: "The hospital app is too complicated.",
          correct: false,
          explanation: "Opinion without user context or direction for redesign."
        },
        {
          id: "c",
          label: "Elderly people find technology difficult.",
          correct: false,
          explanation: "Stereotypes the user group without identifying specific barriers or the system's role in creating them."
        }
      ]
    },
    ideate: {
      ...
      ideas: [
        {
          id: "a",
          label: "Simplified 'senior mode' in the app with large text and voice guidance"
        },
        {
          id: "b",
    ...
    test: {
      prompt: "After a 3-week pilot: the help desk reduced navigation complaints by 60%. However, it has a queue at peak times and some patients still miss appointments due to booking confusion. What do you decide?",
      feedback: "Help desk is effective but creates a new bottleneck. Booking remains a gap.",
      options: [
        {
          id: "a",
          label: "Iterate: add telephone booking and a second help desk agent during peak hours to address both remaining pain points",
          correct: true,
          explanation: "Targets both identified gaps simultaneously with low-cost, proven solutions."
        },
        {
          id: "b",
          label: "Launch the current system — 60% improvement is significant progress",
          correct: false,
          explanation: "Remaining missed appointments represent real patient harm. Iteration is the appropriate design thinking response."
        },
        {
          id: "c",
          label: "Redesign the entire digital system from scratch",
          correct: false,
          explanation: "Over-engineering: the non-digital interventions are already working. Iteration, not overhaul, is indicated."
        }
      ]
    }
  },
  {
    ...
    context: "1,200 students, fixed menu, large portions, no tracking of what is wasted.",
    empathize: {
      prompt: "Best method to understand the waste problem:",
      options: [
        {
          id: "a",
          label: "Measure and categorise the waste at collection point for 5 consecutive days and survey students on why they leave food",
          correct: true,
          explanation: "Mixed method: quantitative waste data combined with qualitative user insight gives a complete picture."
        },
        {
          id: "b",
          label: "Ask the canteen manager what they think causes waste",
          correct: false,
          explanation: "Single stakeholder perspective, likely to identify symptoms rather than root causes."
        },
        {
          id: "c",
          label: "Look at international reports on school food waste",
          correct: false,
          explanation: "Secondary research lacks context for this specific school's population and culture."
        }
      ]
    },
    define: {
      ...
      options: [
        {
          id: "a",
          label: "The canteen needs a system to match food production to actual student demand because portions and menu choices are currently based on assumptions rather than data, generating avoidable daily waste.",
          correct: true,
          explanation: "Identifies the root cause (data gap), not just the symptom (waste), and points toward a data-driven solution space."
        },
        {
          id: "b",
          label: "Students do not eat all their food.",
          correct: false,
          explanation: "Symptom-level observation. Does not identify why, for whom, or how to solve it."
        },
        {
          id: "c",
          label: "The canteen cooks too much food.",
          correct: false,
          explanation: "Partially correct but does not identify the underlying cause — lack of demand prediction data."
        }
      ]
    },
    ideate: {
    ...
    test: {
      prompt: "After 3 weeks: waste reduced by 45%. However, only 60% of students completed pre-orders; the other 40% grabbed whatever was left, undermining prediction accuracy. What do you decide?",
      feedback: "Strong waste reduction but pre-order adoption is incomplete, limiting demand prediction.",
      options: [
        {
          id: "a",
          label: "Iterate: make pre-order the default and introduce a small incentive (priority queue) to increase adoption to 90%+",
          correct: true,
          explanation: "Behavioural design principle: make the desired behaviour the default and the easiest option."
        },
        {
          id: "b",
          label: "Launch as-is — 45% waste reduction is a clear success",
          correct: false,
          explanation: "Significant improvement but the 40% non-adopters are the key lever for further gains."
        },
        {
          id: "c",
          label: "Make pre-ordering mandatory and penalise non-compliance",
          correct: false,
          explanation: "Coercive approach likely to generate resentment and reduce overall participation."
        }
      ]
    }
  }
...
const INNOVATION_CHALLENGES = [
  {
    ...
    solutions: [
      ...
      {
        id: "b",
        label: "Physical book-sharing hut with sealed wooden shelves and a community ledger",
  ...
  {
    title: "Design a low-cost health screening system for elderly patients in remote areas",
    constraints: [
    ...
    solutions: [
      ...
      {
        id: "b",
        label: "Community health worker with a basic vitals kit and paper checklist",
        modelRatings: { feasibility: 5, desirability: 4, viability: 5 },
        justifications: [
  ...
  },
  {
    ...
    solutions: [
      ...
      {
        id: "b",
        label: "Subsidised reusable bag depot at market entrance with deposit-return scheme",
        modelRatings: { feasibility: 4, desirability: 4, viability: 4 },
        justifications: [
      ...
      {
        id: "f",
        label: "Biodegradable bag produced and sold locally by women's cooperative",
  ...
  },
  {
    ...
    solutions: [
      ...
      {
        id: "b",
        label: "Peer reading pairs: stronger readers mentor weaker ones with structured guides",
        modelRatings: { feasibility: 5, desirability: 4, viability: 5 },
        justifications: [
          "No additional cost",
  ...
  {
    title: "Design a solution for traffic congestion in a secondary school drop-off zone",
    constraints: [
    ...
    solutions: [
      {
        id: "a",
        label: "Staggered start times: different year groups arrive at 20-minute intervals",
      ...
      {
        id: "b",
        label: "Kiss-and-drop zone with 2-minute maximum stop time, enforced by staff",
        modelRatings: { feasibility: 4, desirability: 3, viability: 4 },
        justifications: [
      ...
      {
        id: "c",
        label: "Subsidised school bus network reducing private drop-offs by 60%",
        modelRatings: { feasibility: 2, desirability: 5, viability: 2 },
        justifications: [
...
function InnovationLab({ config, onGameEnd }) {
  ...
  const [selectedProto, setSelectedProto] = reactExports.useState([]);
  ...
  function handleEmpathizeDefine(correct) {
    nextStage(correct ? 200 * config.difficulty : 50);
  }
  function handleIdeate(sc) {
  ...
  function handlePrototype() {
    ...
    const correct = needed.every((id) => selectedProto.includes(id)) && !st.components.filter((c) => !c.needed).some((c) => selectedProto.includes(c.id));
    nextStage(correct ? 300 * config.difficulty : 100);
  }
  function handleTest(good) {
  ...
  const [dtProblems] = reactExports.useState(
    () => [...DESIGN_PROBLEMS].sort(() => Math.random() - 0.5).slice(0, dtCount)
  );
  const [dtPhase, setDtPhase] = reactExports.useState("idle");
  const [dtIdx, setDtIdx] = reactExports.useState(0);
  const [dtRanking, setDtRanking] = reactExports.useState([]);
  const [dtPrototype, setDtPrototype] = reactExports.useState([]);
  const [dtFeedback, setDtFeedback] = reactExports.useState(null);
  ...
  function handleDtChoice(correct, pts, next) {
    setScore(
  ...
  function submitDtPrototype() {
    const needed = dtProblem.prototype.features.filter((f) => f.needed).map((f) => f.id);
    const correct = needed.every((id) => dtPrototype.includes(id)) && dtPrototype.length === dtProblem.prototype.neededCount;
    setScore((s) => s + (correct ? 300 : 80) * config.difficulty);
    setDtPhase("test");
  }
  function toggleDtRank(id) {
    setDtRanking(
      (prev) => prev.includes(id) ? prev.filter((x) => x !== id) : [...prev, id]
    );
  }
  const icCount = config.difficulty === 1 ? 2 : config.difficulty === 2 ? 3 : 5;
  const [icChallenges] = reactExports.useState(
    () => [...INNOVATION_CHALLENGES].sort(() => Math.random() - 0.5).slice(0, icCount)
  );
  const [icPhase, setIcPhase] = reactExports.useState("idle");
  const [icIdx, setIcIdx] = reactExports.useState(0);
  const [icRatings, setIcRatings] = reactExports.useState({});
  const [icSelected, setIcSelected] = reactExports.useState(null);
  const [icJustifications, setIcJustifications] = reactExports.useState([]);
  const [icSubmitted, setIcSubmitted] = reactExports.useState(false);
  ...
  function setIcRating(solId, dim, val) {
    setIcRatings((prev) => ({
      ...prev,
      [solId]: {
  ...
  function toggleIcJustification(j) {
    setIcJustifications(
      (prev) => prev.includes(j) ? prev.filter((x) => x !== j) : prev.length < 2 ? [...prev, j] : prev
    );
  }
  function submitIcJustification() {
    ...
    const correctJust = icJustifications.filter(
      (j) => bestSolution == null ? void 0 : bestSolution.bestJustifications.includes(j)
    ).length;
    let ratingPts = 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        gameId === "invention-workshop" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    children: "Invention Workshop"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-center max-w-sm text-sm", children: "Apply the 5-stage design thinking process: Empathize, Define, Ideate, Prototype, Test. Solve real-world problems with creative solutions." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
          ...
          g1Phase === "playing" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-4 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[#8b5cf6] font-mono", children: [
                "Score: ",
                score.toLocaleString()
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: STAGE_ORDER.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-[#8b5cf6]/30 bg-card/40 p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-[#8b5cf6] uppercase tracking-widest", children: stage }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mt-1", children: challenge.problem }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: challenge.context })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  (stage === "empathize" || stage === "define") && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: challenge.stages[stage].prompt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: challenge.stages[stage].options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                  ...
                  stage === "ideate" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: challenge.stages.ideate.prompt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: challenge.stages.ideate.options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                  ...
                  stage === "prototype" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: challenge.stages.prototype.prompt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: challenge.stages.prototype.components.map((comp) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        onClick: () => setSelectedProto(
                          (prev) => prev.includes(comp.id) ? prev.filter((x) => x !== comp.id) : [...prev, comp.id]
                        ),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: "Build Prototype"
                      }
                    )
                  ] }),
                  stage === "test" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: challenge.stages.test.prompt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: challenge.stages.test.outcomes.map((out) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
        ...
        gameId === "design-thinking" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          dtPhase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0 },
              animate: { opacity: 1 },
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-center max-w-sm text-sm", children: [
                  dtCount,
                  " real design problems. Work through 5 phases: Empathize, Define, Ideate, Prototype, Test. Make key decisions at each phase."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: "Begin Design Process"
                  }
                )
              ]
            }
          ),
          dtProblem && (dtPhase === "empathize" || dtPhase === "define" || dtPhase === "test") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-[#a855f7]/30 bg-card/40 p-3 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-[#a855f7] uppercase tracking-widest", children: [
                dtPhase,
                " — Problem ",
                dtIdx + 1,
                "/",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mt-1", children: dtProblem.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: dtProblem.context })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  dtPhase === "empathize" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: dtProblem.empathize.prompt }),
                    dtProblem.empathize.options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        onClick: () => handleDtChoice(opt.correct, 200, "define"),
                  ...
                  dtPhase === "define" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: dtProblem.define.prompt }),
                    dtProblem.define.options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        onClick: () => handleDtChoice(opt.correct, 250, "ideate"),
                        className: "w-full text-left px-4 py-3 rounded-xl border-2 border-border/30 bg-card/60 text-sm hover:border-[#a855f7]/50 transition-all",
                  ...
                  dtPhase === "test" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: dtProblem.test.prompt }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground italic", children: dtProblem.test.feedback }),
                    dtProblem.test.options.map((opt) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        type: "button",
                        onClick: () => handleDtChoice(opt.correct, 300, "result"),
                        className: "w-full text-left px-4 py-3 rounded-xl border-2 border-border/30 bg-card/60 text-sm hover:border-[#a855f7]/50 transition-all",
          ...
          dtProblem && dtPhase === "ideate" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-[#a855f7]/30 bg-card/40 p-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-[#a855f7] uppercase tracking-widest", children: [
              "Ideate — ",
              dtProblem.title
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: dtProblem.ideate.prompt }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
              "Click ideas to rank them (first click = rank 1, most creative/practical). Selected: ",
              dtRanking.length,
              "/6"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: dtProblem.ideate.ideas.map((idea, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: idea.label }),
                    isRanked && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-[#a855f7] shrink-0 ml-2", children: [
                      "#",
                      rankPos + 1
                    ] })
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: "Submit Ranking"
              }
            )
          ] }),
          dtProblem && dtPhase === "prototype" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-[#a855f7]/30 bg-card/40 p-3 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-[#a855f7] uppercase tracking-widest", children: [
              "Prototype — Select ",
              dtProblem.prototype.neededCount,
              " MVP features from ",
              dtProblem.prototype.features.length
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: dtProblem.prototype.prompt }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-2", children: dtProblem.prototype.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setDtPrototype(
                  (prev) => prev.includes(f.id) ? prev.filter((x) => x !== f.id) : prev.length < dtProblem.prototype.neededCount ? [...prev, f.id] : prev
                ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                disabled: dtPrototype.length !== dtProblem.prototype.neededCount,
        ...
        gameId === "innovation-challenge" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          icPhase === "idle" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0 },
              animate: { opacity: 1 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "h2",
                  {
                    ...
                    style: { fontFamily: "'Orbitron', sans-serif" },
                    children: "Innovation Challenge"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-center max-w-sm text-sm", children: [
                  icCount,
                  " constrained challenges. Rate each solution on Feasibility, Desirability, and Viability (1-5). Select the best and justify your choice."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
          ...
          icChallenge && (icPhase === "rating" || icPhase === "justify") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col gap-3 overflow-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-[#00f5ff]/30 bg-card/40 p-3 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-[#00f5ff] uppercase tracking-widest", children: [
                "Challenge ",
                icIdx + 1,
                "/",
                icChallenges.length
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold mt-1", children: icChallenge.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                "Constraints: ",
                icChallenge.constraints.join(" | ")
              ] })
            ] }),
            icPhase === "rating" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Rate each solution 1-5 on Feasibility, Desirability, and Viability. Then submit to see your top choice." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: icChallenge.solutions.map((sol) => {
                const r = icRatings[sol.id] ?? {
                  feasibility: 0,
                  desirability: 0,
                  viability: 0
                };
                const total = r.feasibility + r.desirability + r.viability;
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: "rounded-xl border border-border/30 bg-card/40 p-3",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-foreground mb-2", children: sol.label }),
                      [
                        "feasibility",
                        "desirability",
                        "viability"
                      ].map((dim) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          className: "flex items-center gap-2 mb-1",
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground w-20 shrink-0 capitalize", children: dim }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [1, 2, 3, 4, 5].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                                type: "button",
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground w-4 text-right", children: r[dim] || "" })
                          ]
                        },
                        dim
                      )),
                      total > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-[#00f5ff] mt-1", children: [
                        "Total: ",
                        total,
                        "/15"
                      ] })
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  disabled: icChallenge.solutions.some((s) => {
                    ...
                    return !r || r.feasibility === 0 || r.desirability === 0 || r.viability === 0;
                  }),
                  className: "px-6 py-2 rounded-lg font-bold text-sm disabled:opacity-40",
                  style: { background: "#00f5ff", color: "black" },
                  "data-ocid": "innovation_lab.ic_submit_ratings",
                  children: "Select Best Solution"
                }
              )
            ] }),
            icPhase === "justify" && icSelected && (() => {
              const sol = icChallenge.solutions.find(
                (s) => s.id === icSelected
              );
              if (!sol) return null;
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-[#00f5ff]/30 bg-[#00f5ff]/10 p-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-[#00f5ff] mb-1", children: "Your highest-rated solution:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: sol.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    "Score: ",
                    getIcTotal(icSelected),
                    "/15"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-foreground", children: "Select 2 key reasons that best justify this choice:" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: sol.justifications.map((j, ji) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    onClick: () => !icSubmitted && toggleIcJustification(j),
                ...
                !icSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                    ...
                    children: "Confirm Justification"
                  }
                ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-[#10b981]/30 bg-[#10b981]/10 p-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-[#10b981] mb-1", children: "Best justifications for this solution:" }),
                    sol.bestJustifications.map((j, ji) => /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground", children: j }, ji))
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      ...
                      children: icIdx + 1 < icChallenges.length ? "Next Challenge" : "Finish"
                    }
                  )
                ] })
              ] });
